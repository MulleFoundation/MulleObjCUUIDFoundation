...
#
# src/uuid4 nodetype: ${UUID4_NODETYPE:-git}
#
export UUID4_NODETYPE="git"


#
# src/uuid4 url: ${UUID4_URL:-https://github.com/MulleFoundation/uuid4.git}
#
export UUID4_URL="https://github.com/MulleFoundation/uuid4.git"


#
# src/uuid4 branch: ${UUID4_BRANCH:-mulle}
#
export UUID4_BRANCH="prerelease"
